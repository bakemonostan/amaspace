        ...
        {mobileOpen && (
          <>
            ...
            <motion.div
              ...
              <div className='container-site flex flex-1 flex-col pb-7 pt-5'>
                <div className='w-full pt-16'>
                  ...
                  <Link
                    to='/request-quote'
                    className='cta-glow-primary mt-5 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-orange px-4 py-3 text-sm font-semibold text-white hover:bg-orange-hover'
                    onClick={closeAll}>
                    Request a Quote
